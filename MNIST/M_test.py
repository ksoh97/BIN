import os
import numpy as np
from MNIST import M_utils as utils
import matplotlib.pyplot as plt
from scipy.linalg import sqrtm

def visualization(save_path, images_test, dec_model):
    ...
    CFmap = dec_model({"dec_in": np.expand_dims(total_input, axis=-1), "c1": c1, "c2": c2, "c3": c3}, training=False)[
        "dec_out"]
    ...
    plt.savefig(plt_path + "visualization.png")
