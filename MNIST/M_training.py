...
from MNIST import M_config as conf, M_network as net
from MNIST import M_utils, M_losses, M_test
import numpy as np
import GPUtil
import tqdm
import os
    ...
    def train(self):
        ...
        if mode == 0:
            ...
            for cur_epoch in tqdm.trange(0, epoch, desc=file_name):
                ...
                M_test.visualization(self.save_path, images_test, self.dec_model)
